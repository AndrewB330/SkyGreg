...
public class MachineSieveBronze
        extends GT_MetaTileEntity_BasicMachine_Bronze {

    public MachineSieveBronze(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional, "For gold rushers!", 2, 9, false);
    }

    public MachineSieveBronze(String aName, String[] aDescription, ITexture[][][] aTextures) {
        super(aName, aDescription, aTextures, 2, 9, false);
    }

    public Object getClientGUI(int aID, InventoryPlayer aPlayerInventory, IGregTechTileEntity aBaseMetaTileEntity) {
        return new GT_GUIContainer_BasicMachine(aPlayerInventory, aBaseMetaTileEntity, getLocalName(), "BronzeSieve.png", Recipes.sSieveRecipes.mUnlocalizedName);
    }

    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MachineSieveBronze(this.mName, this.mDescriptionArray, this.mTextures);
    }
    ...
    public int checkRecipe() {
        GT_Recipe_Map tMap = Recipes.sSieveRecipes;
    ...
    public boolean allowPutStack(IGregTechTileEntity aBaseMetaTileEntity, int aIndex, byte aSide, ItemStack aStack) {
        ...
        return Recipes.sSieveRecipes.containsInput(GT_Utility.copyAmount(64L, new Object[]{aStack}));
    }
