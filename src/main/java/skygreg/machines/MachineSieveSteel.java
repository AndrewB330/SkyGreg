...
public class MachineSieveSteel
        extends GT_MetaTileEntity_BasicMachine_Steel {

    public MachineSieveSteel(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional, "For gold rushers!", 2, 9, false);
    }

    public MachineSieveSteel(String aName, String aDescription, ITexture[][][] aTextures) {
    ...
    public Object getClientGUI(int aID, InventoryPlayer aPlayerInventory, IGregTechTileEntity aBaseMetaTileEntity) {
        return new GT_GUIContainer_BasicMachine(aPlayerInventory, aBaseMetaTileEntity, getLocalName(), "SteelSieve.png", Recipes.sSieveRecipes.mUnlocalizedName);
    }

    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MachineSieveSteel(this.mName, this.mDescriptionArray, this.mTextures);
    }
